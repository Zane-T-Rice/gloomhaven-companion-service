...
resource "aws_cloudwatch_log_group" "gloomhaven_companion_service_websocket_disconnect" {
  name = "/aws/lambda/${aws_lambda_function.gloomhaven_companion_service_websocket_disconnect.function_name}"
...
resource "aws_lambda_permission" "allow_api_gateway_disconnect" {
  ...
  function_name = aws_lambda_function.gloomhaven_companion_service_websocket_disconnect.function_name
